...
class TopicController extends Controller
{
    ...
    public function show(Request $request, Course $course, Topic $topic)
    {
        ...
        $prev = Topic::where('sorting', '<', $topic->sorting)->where('course_id', $topic->course_id)->where('chapter_id', $topic->chapter_id)->orderBy('sorting', 'desc')->orderBy('id', 'desc')->first();
        $next = Topic::where('sorting', '>', $topic->sorting)->where('course_id', $topic->course_id)->where('chapter_id', $topic->chapter_id)->orderBy('sorting', 'asc')->orderBy('id', 'asc')->first();
